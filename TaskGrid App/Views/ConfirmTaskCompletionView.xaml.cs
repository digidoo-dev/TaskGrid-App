...
public partial class ConfirmTaskCompletionView : ContentPage
{
    private int _taskId;
    ...
    public ConfirmTaskCompletionView()
	{
		InitializeComponent();
	}
    ...
    private async void OnClicked_Confirm(object sender, EventArgs e)
    {
        ...
        try
        {
            var response = await client.PostAsJsonAsync("https://taskgrid-ghh2c3c6cwf0breu.polandcentral-01.azurewebsites.net/API/FinishTask", new
            {
                TaskId = _taskId
            });
